...
Public Class ByteErg_Test
    ...
    Private Sub ByteErg_Test_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CurrentTimeTimer_Tick(sender As Object, e As EventArgs) Handles CurrentTimeTimer.Tick
        ...
        If THT_Start.Checked = True Then
            PCBCheckRes = CheckPCB(SerialTextBox.Text, Controllabel, SerialTextBox, BT_Pause, DG_THT_Start)
        Else
            PCBCheckRes = New ArrayList()
            PCBCheckRes.Add(True)
            PCBCheckRes.Add(SelectInt("use SMDCOMPONETS SELECT [IDLaser] FROM [SMDCOMPONETS].[dbo].[LazerBase] 
                                            where Content = '" & SerialTextBox.Text & "'"))
        End If
        ...
        Private Function GetStepResult() As ArrayList
            ...
            Mess.AddRange(New ArrayList() From {"Ошибка", "Плата " & SerialTextBox.Text & " не прошла этап " & PreStep & "!" &
            ...
            Mess.AddRange(New ArrayList() From {"Ошибка", "Плата " & SerialTextBox.Text & " уже прошла этап " & PCInfo(7) & "!" &
            ...
            Mess.AddRange(New ArrayList() From {"Карантин", "Плата " & SerialTextBox.Text & " находится в карантине!" &
            ...
            Mess.AddRange(New ArrayList() From {"Ошибка", "Плата " & SerialTextBox.Text & " пришла из ремонта." & vbCrLf &
            ...
            Mess.AddRange(New ArrayList() From {"Ошибка", "Плата " & SerialTextBox.Text & " имеет не верный предыдыдущий шаг! " & vbCrLf &
        ...
        Private Sub UpdateStepRes(StepID As Integer, StepRes As Integer, PcbID As Integer)
            ...
            Select Case StepRes
                Case 2
                Message = "Плата " & SerialTextBox.Text & " прошла этап " & PCInfo(7) & "!" &
                ...
                Message = "Плата " & SerialTextBox.Text & " не прошла этап " & PCInfo(7) & "!" &
                ...
                MesColor = Color.Red
                    CurrentLogUpdate(Label_ShiftCounter.Text, SerialTextBox.Text, "Карантин", ErrCode(1), "Плата не прошла этап " & PCInfo(7) & "!" &
                      vbCrLf & "Передайте плату в ремонт!")
                Case 5
                Message = "Плата " & SerialTextBox.Text & " имеет не верный предыдыдущий шаг! " & vbCrLf &
                ...
                Case 6
                    StepRes = 2
                    ErrCode = GetErrorCode()
                Message = "Плата " & SerialTextBox.Text & " прошла этап " & PCInfo(7) & " с ошибкой V5!" &
                       vbCrLf & "Передайте плату на следующий этап " & NextStep & "!"
                MesColor = Color.Green
